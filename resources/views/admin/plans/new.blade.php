    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.plans.new') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" name="option_pixels" id="i_option_pixels" class="form-control{{ $errors->has('option_pixels') ? ' is-invalid' : '' }}" value="{{ old('option_pixels') ?? 0 }}">
            ...
            <div class="form-group">
                ...
                <select name="option_targeting" id="i_option_targeting" class="custom-select{{ $errors->has('option_targeting') ? ' is-invalid' : '' }}">
                    @foreach([1 => __('On'), 0 => __('Off')] as $key => $value)
                        <option value="{{ $key }}" @if(old('option_targeting') == $key) selected @endif>{{ $value }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select name="option_data_export" id="i_option_data_export" class="custom-select{{ $errors->has('option_data_export') ? ' is-invalid' : '' }}">
                    @foreach([1 => __('On'), 0 => __('Off')] as $key => $value)
                        <option value="{{ $key }}" @if(old('option_data_export') == $key) selected @endif>{{ $value }}</option>
                    @endforeach
                </select>
