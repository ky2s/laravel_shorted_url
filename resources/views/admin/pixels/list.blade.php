                ...
                @foreach($pixels as $pixel)
                    <div class="list-group-item px-0">
                        <div class="row align-items-center">
                            <div class="col text-truncate">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-lg-5 d-flex align-items-center">
                                        ...
                                        <a href="{{ route('admin.users.edit', $pixel->user->id) }}"@if($pixel->user->trashed()) class="text-danger" @endif>{{ $pixel->user->name }}</a>
                                    </div>
                            ...
                            <div class="col-auto">
                                <a href="{{ route('admin.pixels.edit', $pixel->id) }}" class="btn btn-outline-primary btn-sm">{{ __('Edit') }}</a>
                            </div>
                        </div>
                    </div>
                @endforeach
