        ...
        <form action="{{ route('checkout.subscribe', ['id' => $plan->id, 'period' => request()->period]) }}" method="post" enctype="multipart/form-data" id="payment-form">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4 d-flex flex-column justify-content-start">
                    ...
                    <!-- Agreement -->
                    <div class="mt-3">
                        <span class="small text-muted">{!! __('By continuing, you agree with the :terms and authorize :title to charge your payment method on a recurring basis.', ['terms' => mb_strtolower('<a href="'.config('settings.legal_terms_url').'" target="_blank">'. __('Terms of service') .'</a>'), 'title' => '<strong>'.e(config(('settings.title'))).'</strong>']) !!} {{ __('You can cancel your subscription at any time.') }}</span>
                    </div>
