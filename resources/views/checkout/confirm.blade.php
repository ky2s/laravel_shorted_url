                ...
                <div class="text-decoration-none d-block mt-3">
                    <div class="card border-0 h-100 shadow-sm">
                        <div class="card-body d-flex">
                            <div class="d-flex justify-content-center">@include('icons.background.contact', ['class' => 'text-primary fill-current width-12 height-12 '.(__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3')])</div>
                            <div>
