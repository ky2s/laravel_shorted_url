        ...
        <div class="row">
            ...
            <div class="col-auto">
                <div class="form-row flex-nowrap">
                    ...
                    <div class="col">
                        @include('shared.dropdowns.link', ['class' => 'btn-sm text-primary', 'options' => ['dropdown' => ['button' => true, 'share' => true, 'stats' => true, 'preview' => true, 'open' => true, 'delete' => true]]])
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="space" id="i_space" class="custom-select{{ $errors->has('space') ? ' is-invalid' : '' }}" @cannot('spaces', ['App\Link', $userFeatures['option_spaces']]) disabled @endcannot>
                                <option value="">{{ __('None') }}</option>
                ...
                <div class="col-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" id="i_password" value="{{ isset($admin) ? '' : (old('password') ?? $link->password) }}" autocomplete="new-password" @if(isset($admin)) disabled @else @cannot('password', ['App\Link', $userFeatures['option_password']]) disabled @endcannot @endif>
                        </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="expiration_date" class="form-control{{ $errors->has('expiration_date') ? ' is-invalid' : '' }}" id="i_expiration_date" placeholder="YYYY-MM-DD" value="{{ old('expiration_date') ?? ($link->ends_at ? $link->ends_at->tz(Auth::user()->timezone ?? config('app.timezone'))->format('Y-m-d') : '') }}" @cannot('expiration', ['App\Link', $userFeatures['option_expiration']]) disabled @endcannot>
                            <input type="time" name="expiration_time" class="form-control{{ $errors->has('expiration_time') ? ' is-invalid' : '' }}" placeholder="HH:MM" value="{{ old('expiration_time') ?? ($link->ends_at ? $link->ends_at->tz(Auth::user()->timezone ?? config('app.timezone'))->format('H:i') : '') }}" @cannot('expiration', ['App\Link', $userFeatures['option_expiration']]) disabled @endcannot>
                ...
                <div class="col-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" dir="ltr" name="expiration_url" id="i_expiration_url" class="form-control{{ $errors->has('expiration_url') ? ' is-invalid' : '' }}" autocapitalize="none" spellcheck="false" value="{{ old('expiration_url') ?? $link->expiration_url }}" @cannot('expiration', ['App\Link', $userFeatures['option_expiration']]) disabled @endcannot>
                            <input type="number" name="expiration_clicks" id="i_expiration_clicks" class="form-control {{ $errors->has('expiration_clicks') ? ' is-invalid' : '' }}" autocapitalize="none" spellcheck="false" value="{{ old('expiration_clicks') ?? $link->expiration_clicks }}" @cannot('expiration', ['App\Link', $userFeatures['option_expiration']]) disabled @endcannot>
                            <div class="input-group-append">
                ...
                <div class="col-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="privacy_password" class="form-control{{ $errors->has('privacy_password') ? ' is-invalid' : '' }}" id="i_privacy_password" value="{{ isset($admin) ? '' : (old('privacy_password') ?? $link->privacy_password) }}" autocomplete="new-password" @if(isset($admin)) disabled @else @cannot('stats', ['App\Link', $userFeatures['option_stats']]) disabled @endcannot @endif>
                            <div class="input-group-append">
