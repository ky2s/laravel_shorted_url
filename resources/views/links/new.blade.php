                            ...
                            <div>
                                <div class="input-group input-group-lg">
                                    ...
                                    <div class="input-group-append">
                                        <a href="#" class="btn text-secondary bg-transparent input-group-text d-flex align-items-center" data-toggle="collapse" data-target="#advancedOptions" aria-expanded="false">@include('icons.settings', ['class' => 'fill-current width-4 height-4']) <span class="d-none d-md-block small {{ (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-2') }}">{{ __('Advanced') }}</span></a>
                                    </div>
                                </div>
                                @if ($errors->has('url'))
                    ...
                    <div class="row mt-3">
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="domain" id="i_domain_new" class="custom-select{{ $errors->has('domain') ? ' is-invalid' : '' }}" @cannot('domains', ['App\Link', $userFeatures['option_domains']]) disabled @endcannot>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="alias" class="form-control{{ $errors->has('alias') ? ' is-invalid' : '' }}" autocapitalize="none" spellcheck="false" id="i_alias" value="{{ old('alias') }}" {{ old('multi_link') == 0 && count(session('toast')) <= 1 ? '' : ' disabled' }}>
                                </div>
                                @if ($errors->has('alias'))
                                    <span class="invalid-feedback d-block" role="alert">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="space" id="i_space_new" class="custom-select{{ $errors->has('space') ? ' is-invalid' : '' }}" @cannot('spaces', ['App\Link', $userFeatures['option_spaces']]) disabled @endcannot>
                                        <option value="">{{ __('None') }}</option>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="expiration_date" class="form-control{{ $errors->has('expiration_date') ? ' is-invalid' : '' }}" id="i_expiration_date" placeholder="YYYY-MM-DD" value="{{ old('expiration_date') }}" @cannot('expiration', ['App\Link', $userFeatures['option_expiration']]) disabled @endcannot>
                                    <input type="time" name="expiration_time" class="form-control{{ $errors->has('expiration_time') ? ' is-invalid' : '' }}" placeholder="HH:MM" value="{{ old('expiration_time') }}" @cannot('expiration', ['App\Link', $userFeatures['option_expiration']]) disabled @endcannot>
                                    <div class="input-group-append">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" dir="ltr" name="expiration_url" id="i_expiration_url" class="form-control{{ $errors->has('expiration_url') ? ' is-invalid' : '' }}" autocapitalize="none" spellcheck="false" value="{{ old('expiration_url') }}" @cannot('expiration', ['App\Link', $userFeatures['option_expiration']]) disabled @endcannot>
                                    <input type="number" name="expiration_clicks" id="i_expiration_clicks" class="form-control {{ $errors->has('expiration_clicks') ? ' is-invalid' : '' }}" autocapitalize="none" spellcheck="false" value="{{ old('expiration_clicks') }}" @cannot('expiration', ['App\Link', $userFeatures['option_expiration']]) disabled @endcannot>
                                    <div class="input-group-append">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                <div class="row no-gutters">
                                    <div class="col-6">
                                        <div class="row">
                                            <div class="col"><label for="i_privacy">{{ __('Stats') }}</label></div>
                                            <div class="col-auto">
                                    ...
                                    <div class="col-6 {{ (__('lang_dir') == 'rtl' ? 'text-left' : 'text-right') }}">
                                        <label for="i_privacy_password">{{ __('Password') }}</label>
                                        @cannot('stats', ['App\Link', $userFeatures['option_stats']])
                                            @if(config('settings.stripe'))
                                                <a href="{{ route('pricing') }}" data-enable="tooltip" title="{{ __('Unlock feature') }}">@include('icons.unlock', ['class' => 'fill-current text-primary width-4 height-4'])</a>
                                            @endif
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="privacy" id="i_privacy" class="custom-select{{ $errors->has('privacy') ? ' is-invalid' : '' }}" @cannot('stats', ['App\Link', $userFeatures['option_stats']]) disabled @endcannot>
                                        @foreach([1 => __('Private'), 0 => __('Public'), 2 => __('Password')] as $key => $value)
                                            <option value="{{ $key }}" @if (old('privacy') !== null && old('privacy') == $key) selected @elseif($user->default_stats == $key) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    <input type="password" name="privacy_password" class="form-control{{ $errors->has('privacy_password') ? ' is-invalid' : '' }}" id="i_privacy_password" value="{{ old('privacy_password') }}" autocomplete="new-password">
                                    <div class="input-group-append">
                                        <div class="input-group-text cursor-pointer" data-enable="tooltip" data-title="{{ __('Show password') }}" data-password="i_privacy_password" data-password-show="{{ __('Show password') }}" data-password-hide="{{ __('Hide password') }}">@include('icons.security', ['class' => 'width-4 height-4 fill-current text-muted'])</div>
                                    </div>
                                </div>
                                <div class="row no-gutters">
                                    <div class="col-6">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="disabled" id="i_disabled" class="custom-select{{ $errors->has('disabled') ? ' is-invalid' : '' }}" @cannot('disabled', ['App\Link', $userFeatures['option_disabled']]) disabled @endcannot>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        <label for="i_pixels">{{ __('Pixels') }}</label>
                                    </div>
                                    <div class="col-auto">
                                        @cannot('pixels', ['App\Link', $userFeatures['option_pixels']])
                                            @if(config('settings.stripe'))
                                                <a href="{{ route('pricing') }}" data-enable="tooltip" title="{{ __('Unlock feature') }}">@include('icons.unlock', ['class' => 'fill-current text-primary width-4 height-4'])</a>
                                            @endif
                                        @endcannot
                                ...
                                <select name="pixels[]" id="i_pixels" class="custom-select{{ $errors->has('pixels') ? ' is-invalid' : '' }}" size="{{ (count($pixels) == 0 ? 1 : 3) }}" @cannot('pixels', ['App\Link', $userFeatures['option_pixels']]) disabled @endcannot multiple>
                        ...
                        <div class="col-12">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="country-container" class="tab-pane fade{{ old('target_type') == 1 ? ' show active' : '' }}">
                                    ...
                                    @can('targeting', ['App\Link', $userFeatures['option_targeting']])
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <div class="input-group-text">@include('icons.languages', ['class' => 'width-4 height-4 fill-current text-muted'])</div>
                                                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-auto order-1 order-lg-2">
                                    <div class="d-flex flex-wrap">
                                        <a href="{{ route('settings.preferences') }}" class="btn btn-outline-secondary d-flex align-items-center{{ (__('lang_dir') == 'rtl' ? ' ml-auto ml-lg-3' : ' mr-auto mr-lg-3') }}" data-enable="tooltip" title="{{ __('Preferences') }}">
                                        ...
                                        <div class="btn-group btn-group-toggle d-flex" data-toggle="buttons">
                                            <label class="btn btn-outline-secondary{{ old('multi_link') == 0 && count(session('toast')) <= 1 ? ' active' : ''}} w-100" id="single-link">
                                                <input type="radio" name="multi_link" id="i_multi_link" value="0"{{ old('multi_link') == 0 && count(session('toast')) <= 1 ? ' checked' : ''}}>{{ __('Single') }}
                                            </label>
