<div class="nav-item d-flex">
    <a href="#" class="nav-link py-1 d-flex align-items-center text-secondary" id="dark-mode" data-enable="tooltip" title="{{ __('Change theme') }}" data-dark-mode="{{ (Cookie::get('dark_mode') == 1 ? 1 : 0) }}">
