...
<div class="col-auto">
    <a href="{{ route($export, ['id' => $link->id] + Request::query()) }}" data-toggle="modal" data-target="#exportModal" class="btn btn-sm btn-outline-primary d-flex align-items-center" data-enable="tooltip" title="{{ __('Export') }}">@include('icons.export', ['class' => 'fill-current width-4 height-4'])&#8203;</a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body">
                    @if($remoteUser->can('dataExport', ['App\Link', $remoteUserFeatures['option_data_export']]) || (Auth::check() && Auth::user()->role == 1))
