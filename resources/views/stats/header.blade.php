<div class="bg-base-1 pt-3">
    <div class="container pt-3">
        ...
        <div class="d-flex align-items-end">
            <h2 class="mb-0 flex-grow-1 text-truncate">{{ str_replace(['http://', 'https://'], '', (($link->domain->name ?? config('app.url')) .'/'.$link->alias)) }}</h2>

            <div class="d-flex align-items-center flex-grow-0">
                <div class="form-row flex-nowrap">
                    <div class="col">
                        @include('shared.buttons.copy_link', ['class' => 'text-secondary'])
                    </div>
