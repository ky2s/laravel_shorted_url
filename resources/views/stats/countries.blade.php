                                            ...
                                            @if(isset($first->value))
                                                ...
                                                <div class="flex-grow-1 font-weight-bold text-truncate {{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}">
                                                    @if(!empty(explode(':', $first->value)[1]))
                                                        <a href="{{ route('stats.cities', ['id' => $link->id, 'search' => explode(':', $first->value)[0].':', 'from' => $range['from'], 'to' => $range['to']]) }}" class="text-body">{{ explode(':', $first->value)[1] }}</a>
                                                    @else
                                                        {{ __('Unknown') }}
                                                    @endif
                                                </div>
                                            ...
                                            @if(isset($last->value))
                                                ...
                                                <div class="flex-grow-1 font-weight-bold text-truncate {{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}">
                                                    @if(!empty(explode(':', $last->value)[1]))
                                                        <a href="{{ route('stats.cities', ['id' => $link->id, 'search' => explode(':', $last->value)[0].':', 'from' => $range['from'], 'to' => $range['to']]) }}" class="text-body">{{ explode(':', $last->value)[1] }}</a>
                                                    @else
                                                        {{ __('Unknown') }}
                                                    @endif
                                                </div>
