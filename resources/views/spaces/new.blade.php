                    ...
                    @foreach(formatSpace() as $key => $value)
                        <div class="col-4 col-sm">
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <label class="custom-control-label d-flex align-items-center" for="i_color{{ $key }}"><span class="width-4 height-4 bg-{{ $value }} rounded-circle cursor-pointer"></span></label>
                            </div>
                        </div>
                    @endforeach
                </div>
