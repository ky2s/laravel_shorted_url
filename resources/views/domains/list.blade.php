                                ...
                                <div class="row align-items-center">
                                    <div class="col-12 col-lg-8 d-flex">
                                        <div class="text-truncate">
                                            <div class="d-flex">
                                                <div class="d-flex align-items-center text-truncate" dir="ltr">
                                                    <img src="https://icons.duckduckgo.com/ip3/{{ parse_url($domain->name)['host'] }}.ico" rel="noreferrer" class="width-4 height-4 {{ (__('lang_dir' == 'rtl' ? 'ml-3' : 'mr-3')) }}">
                                                    <div class="text-truncate"><a href="{{ route('domains.edit', $domain->id) }}">{{ str_replace(['http://', 'https://'], '', $domain->name) }}</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-none d-lg-block col-lg-2">
                                        <div class="text-truncate" data-enable="tooltip" title="{{ $domain->created_at->tz(Auth::user()->timezone ?? config('app.timezone'))->format(__('Y-m-d') . ' H:i:s') }}">{{ $domain->created_at->diffForHumans() }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto">
