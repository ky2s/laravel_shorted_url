            ...
            <div class="row mb-5">
                <div class="col-12 col-lg-6 mt-3">
                    <div class="card border-0 shadow-sm">
                        ...
                        @if(count($latestLinks) > 0)
                            <div class="card-footer bg-base-2 border-0">
                                <a href="{{ route('links') }}" class="text-muted font-weight-medium d-flex align-items-center justify-content-center">{{ __('View all') }} @include((__('lang_dir') == 'rtl' ? 'icons.chevron_left' : 'icons.chevron_right'), ['class' => 'width-3 height-3 fill-current '.(__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-2')])</a>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6 mt-3">
                    <div class="card border-0 shadow-sm">
                        ...
                        @if(count($popularLinks) > 0)
                            <div class="card-footer bg-base-2 border-0">
                                <a href="{{ route('links', ['sort' => 'max']) }}" class="text-muted font-weight-medium d-flex align-items-center justify-content-center">{{ __('View all') }} @include((__('lang_dir') == 'rtl' ? 'icons.chevron_left' : 'icons.chevron_right'), ['class' => 'width-3 height-3 fill-current '.(__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-2')])</a>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-12 col-xl-4 mt-3">
                    <div class="card border-0 h-100 shadow-sm">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <div class="text-dark font-weight-medium">{{ __('Create a new space') }}</div>

                                <a href="{{ route('spaces.new') }}" class="text-secondary text-decoration-none stretched-link">{{ __('Organize your links.') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-xl-4 mt-3">
                    <div class="card border-0 h-100 shadow-sm">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <div class="text-dark font-weight-medium">{{ __('Add a new domain') }}</div>

                                <a href="{{ route('domains.new') }}" class="text-secondary text-decoration-none stretched-link">{{ __('Brand your links.') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-xl-4 mt-3">
                    <div class="card border-0 h-100 shadow-sm">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <div class="text-dark font-weight-medium">{{ __('Start using pixels') }}</div>

                                <a href="{{ route('pixels.new') }}" class="text-secondary text-decoration-none stretched-link">{{ __('Retarget your audience.') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
