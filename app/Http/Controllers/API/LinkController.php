...
class LinkController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return LinkResource::collection(Link::with('domain', 'space')->where('user_id', $user->id)
            ...
            ->paginate($perPage)
            ->appends(['search' => $search, 'domain' => $domain, 'space' => $space, 'by' => $by, 'sort' => $request->input('sort'), 'per_page' => $perPage]))
