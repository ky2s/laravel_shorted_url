    ...
    protected function getFeatures($user)
    {
        ...
        foreach ($plans as $plan) {
            foreach ($plan as $key => $value) {
                if (in_array($key, ['option_api', 'option_links', 'option_spaces', 'option_domains', 'option_pixels', 'option_stats', 'option_targeting', 'option_expiration', 'option_password', 'option_disabled', 'option_utm', 'option_global_domains', 'option_deep_links', 'option_data_export'])) {
